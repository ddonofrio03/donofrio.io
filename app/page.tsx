...
const team = [
  ...
  { name: "Bill D'Onofrio", role: "Lead Listener", image: "/images/bill.jpg", bio: "Bill brings decades of experience leading teams and finding the path that fits a client's needs, budget, and goals." },
   { name: "Donna D'Onofrio", role: "Lead Heart", image: "/images/donna.png", bio: "Donna guides with devotion and heart. Keeps life, family, and business in rhythm—and gets it all done in two minutes." },
